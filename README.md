...
Aussie EcoLens is a FIT5225 Assignment 2 project for a serverless wildlife media platform. It allows users to upload wildlife images and videos, processes the media with ML-based species tagging, stores metadata, and supports querying, tag management, visibility changes, deletion, and tag notification workflows.
